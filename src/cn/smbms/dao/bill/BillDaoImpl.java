...
public class BillDaoImpl implements BillDao {
	...
	@Override
	public List<Bill> getBillList(Connection connection, String productName,String providerId,String isPayment)
			throws Exception {
		// TODO Auto-generated method stub
		PreparedStatement pstm = null;
		ResultSet rs = null;
		...
		if(connection != null){
			...
			if(!StringUtils.isNullOrEmpty(providerId)){
				sql.append(" and providerId like ?");
				list.add(providerId);
			}
			if(!StringUtils.isNullOrEmpty(isPayment)){
				sql.append(" and isPayment like ?");
				list.add(isPayment);
			}
	...
	@Override
	public List<Bill> getBillList(Connection connection) throws Exception {
